...
AsasecFX_CFLAGS = -fobjc-arc $(HEADER_PATHS) -Wno-nullability-completeness -Wno-unused-property-ivar -Wno-unused-variable -Wno-switch -Wno-deprecated-declarations -Wno-unused-but-set-variable
